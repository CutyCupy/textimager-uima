...
/**
 * Neuralnetwork NER base class. Use the analysis engine description parameter
 * PARAM_MODEL_NAME to choose from the four possible models.
 *
 * See 'models' in neuralnetwork_ner_rest.py in the python implementation for
 * more details.
 *
