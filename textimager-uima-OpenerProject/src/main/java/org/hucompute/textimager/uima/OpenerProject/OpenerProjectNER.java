...
@TypeCapability(inputs = { "org.dkpro.core.api.segmentation.type.Token",
	...
	"org.dkpro.core.api.lexmorph.type.morph.Morpheme" }, outputs = { "org.dkpro.core.api.ner.type.NamedEntity" })
public class OpenerProjectNER extends JCasAnnotator_ImplBase {
	...
	mappingProvider.setDefaultVariantsLocation(
		"classpath:/org/hucompute/textimager/uima/OpenerProject/lib/ner-default.map");
