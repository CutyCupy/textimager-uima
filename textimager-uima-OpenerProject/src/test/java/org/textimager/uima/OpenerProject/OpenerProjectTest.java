...
import org.hucompute.textimager.uima.OpenerProject.OpenerProjectConstituentCoref;
import org.hucompute.textimager.uima.OpenerProject.OpenerProjectLanguageIdentifier;
import org.hucompute.textimager.uima.OpenerProject.OpenerProjectNER;
import org.hucompute.textimager.uima.OpenerProject.OpenerProjectPOSTagger;
import org.hucompute.textimager.uima.OpenerProject.OpenerProjectTokenizer;
...
public class OpenerProjectTest {
	...
	builder.add(createEngineDescription(OpenerProjectTokenizer.class));
	...
	AssertAnnotations.assertToken(new String[] { "Ceci", "est", "un", "bon", "test", "." },
	...
	AssertAnnotations.assertToken(new String[] { "Das", "ist", "ein", "guter", "Test", "." },
		JCasUtil.select(cas, Token.class));
	...
	AggregateBuilder builder = new AggregateBuilder();
	builder.add(createEngineDescription(OpenerProjectLanguageIdentifier.class));
	SimplePipeline.runPipeline(cas, builder.createAggregate());
	...
	AggregateBuilder builder = new AggregateBuilder();
	builder.add(
		createEngineDescription(OpenerProjectPOSTagger.class, OpenerProjectPOSTagger.PARAM_POS_MAPPING_LOCATION,
	...
	assertPOS(new String[] { "PR", "V", "ART", "ADJ", "NN", "O" }, new String[] { "R", "V", "D", "A", "G", "O" },
	...
	JCas cas = JCasFactory.createText(
		"Merkel wuchs in der DDR auf und war dort als Physikerin wissenschaftlich tätig. Bei der Bundestagswahl am 2. Dezember 1990 errang sie erstmals ein Bundestagsmandat; in allen darauffolgenden sechs Bundestagswahlen wurde sie in ihrem Wahlkreis in Vorpommern direkt gewählt.",
		"de");
//		JCas cas = JCasFactory.createText(
...
//				, "en");
	...
	builder.add(
		createEngineDescription(OpenerProjectPOSTagger.class, OpenerProjectPOSTagger.PARAM_POS_MAPPING_LOCATION,
			...
			OpenerProjectPOSTagger.PARAM_JRUBY_LOCATION, "~/jruby/bin/"));
	builder.add(
		createEngineDescription(OpenerProjectNER.class, OpenerProjectNER.PARAM_NAMED_ENTITY_MAPPING_LOCATION,
			"src/main/resources/org/hucompute/textimager/uima/OpenerProject/lib/ner-default.map"));
	SimplePipeline.runPipeline(cas, builder.createAggregate());
...
//				, "en");
	...
	builder.add(
		createEngineDescription(OpenerProjectPOSTagger.class, OpenerProjectPOSTagger.PARAM_POS_MAPPING_LOCATION,
			"src/main/resources/org/hucompute/textimager/uima/OpenerProject/lib/pos-default.map",
			OpenerProjectPOSTagger.PARAM_JRUBY_LOCATION, "~/jruby/bin/"));
	builder.add(createEngineDescription(OpenerProjectConstituentCoref.class,
		OpenerProjectConstituentCoref.PARAM_CONSTITUENT_MAPPING_LOCATION,
		"src/main/resources/org/hucompute/textimager/uima/OpenerProject/lib/constituent-en-default.map"));
	SimplePipeline.runPipeline(cas, builder.createAggregate());
...
//	@Test
	...
	token.add(createEngineDescription(OpenerProjectTokenizer.class));

	AggregateBuilder POS = new AggregateBuilder();
	POS.add(createEngineDescription(OpenerProjectPOSTagger.class, OpenerProjectPOSTagger.PARAM_POS_MAPPING_LOCATION,
		"src/main/resources/org/hucompute/textimager/uima/OpenerProject/lib/pos-default.map"));

	AggregateBuilder Const = new AggregateBuilder();
	Const.add(createEngineDescription(OpenerProjectConstituentCoref.class,
		OpenerProjectConstituentCoref.PARAM_CONSTITUENT_MAPPING_LOCATION,
		"src/main/resources/org/hucompute/textimager/uima/OpenerProject/lib/constituent-en-default.map"));

	AggregateBuilder NER = new AggregateBuilder();
	NER.add(createEngineDescription(OpenerProjectNER.class, OpenerProjectNER.PARAM_NAMED_ENTITY_MAPPING_LOCATION,
		"src/main/resources/org/hucompute/textimager/uima/OpenerProject/lib/ner-default.map"));
    ...
    public long RunPipe(JCas cas, AggregateBuilder builder)
