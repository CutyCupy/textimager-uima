...
/**
 * Collection reader for PDF files. Uses simple heuristics to detect headings
 * and paragraphs.
 *
...
public class PdfReader {
    ...
    /**
     * The location of the substitution table use to post-process the text extracted
     * form the PDF, e.g. to convert ligatures to separate characters.
     */
