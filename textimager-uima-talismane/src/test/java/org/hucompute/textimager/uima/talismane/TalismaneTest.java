...
public class TalismaneTest {
	...
	builder.add(createEngineDescription(TalismaneSegmenter.class, TalismaneSegmenter.PARAM_CONFIG_LOCATION,
		"org/hucompute/textimager/uima/talismane/talismane-fr-4.1.0.conf"));
	...
	AssertAnnotations.assertSentence(new String[] { "Ceci est un bon test." },
	...
	AggregateBuilder builder = new AggregateBuilder();
	builder.add(createEngineDescription(TalismanePOS.class, TalismanePOS.PARAM_POS_MAPPING_LOCATION,
		"src/main/resources/org/hucompute/textimager/uima/talismane/lib/pos-default.map",
		TalismanePOS.PARAM_CONFIG_LOCATION, "org/hucompute/textimager/uima/talismane/talismane-fr-4.1.0.conf"));

	AssertAnnotations.assertLemma(new String[] { "ceci", "être", "un", "bon", "test", "." },
		JCasUtil.select(cas, Lemma.class));
	AssertAnnotations.assertPOS(new String[] { "N", "V", "ART", "ADJ", "N", "PUNC" },
		new String[] { "NPP", "V", "DET", "ADJ", "NC", "PONCT" }, JCasUtil.select(cas, POS.class));
	...
	builder.add(createEngineDescription(TalismanePOS.class, TalismanePOS.PARAM_POS_MAPPING_LOCATION,
		"src/main/resources/org/hucompute/textimager/uima/talismane/lib/pos-default.map",
		TalismanePOS.PARAM_CONFIG_LOCATION, "org/hucompute/textimager/uima/talismane/talismane-fr-4.1.0.conf"));
	builder.add(createEngineDescription(TalismaneDependencyParser.class,
		TalismaneDependencyParser.PARAM_DEPENDENCY_MAPPING_LOCATION,
		"src/main/resources/org/hucompute/textimager/uima/talismane/lib/dependency-default.map",
		TalismaneDependencyParser.PARAM_CONFIG_LOCATION,
		"org/hucompute/textimager/uima/talismane/talismane-fr-4.1.0.conf"));
	...
	// AssertAnnotations.assertToken(new String[] {"Ceci", "est", "un", "bon",
	// "test","."}, JCasUtil.select(cas, Token.class));
	// AssertAnnotations.assertSentence(new String[] {"Ceci est un bon test."},
	// JCasUtil.select(cas, Sentence.class));
